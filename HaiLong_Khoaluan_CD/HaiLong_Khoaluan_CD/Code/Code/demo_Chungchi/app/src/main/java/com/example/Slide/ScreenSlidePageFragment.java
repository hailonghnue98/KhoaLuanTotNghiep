...
public class ScreenSlidePageFragment extends Fragment {
    ...
    private TextView txtQuestionNumber, txtQuestion, txtExam, tvThongbao, tvGiaithich, tvSubject;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        screenSlideActivity = (ScreenSlideActivity) getActivity();
...
//        listAnswer.add(question.getAns_d());
        ...
        if(checkNopBai != 0)
        {
            ...
            {
                markWrongAnswer(getKeyfromResult(answer));
...
//                Toast.makeText(getActivity(), "Ban chon " + getChoice(i), Toast.LENGTH_SHORT).show();
    ...
    public static ScreenSlidePageFragment create(int pageNumber, int nopbai, ArrayList<Integer> vitriCauhoi, int maDe)
    {
